...
Required parameter:
    ...
    2. pageId   : This is the id of a Project and used to retrieve NGPage.
            ...
            <form name="fileExist" id="fileExist" action="fileExists.form" method="post">
                ...
                <table border="0px solid red" class="linkWizard">
                    ...
                    <tr>
                        ...
                        <td style="width:20px;"></td>
                        <td>
                            <input type="submit" value="Ok" title="Ok" class="inputBtn"/>
                            <input type="button" value="Cancel" title="Cancel" class="inputBtn" onclick="submitForm()"/>
                        </td>
                    </tr>
                    <tr><td style="height:40px"></td></tr>
                </table>

...
%>
            ...
            <tr>
                ...
                <input type="radio" name="state" value="<%=BaseRecord.STATE_UNSTARTED%>"/>
                    <img src="<%ar.writeHtml(GoalRecord.stateImg(BaseRecord.STATE_UNSTARTED));%>"/>
                    <%
                ...
                <input type="radio" name="state" value="<%=BaseRecord.STATE_STARTED%>" checked="checked" />
                    <img src="<%ar.writeHtml(GoalRecord.stateImg(BaseRecord.STATE_STARTED));%>"/>
                    <%
                        ar.writeHtml(GoalRecord.stateName(BaseRecord.STATE_STARTED));
                    %><br/>

                <input type="radio" name="state" value="<%=BaseRecord.STATE_ACCEPTED%>"/>
                    <img src="<%ar.writeHtml(GoalRecord.stateImg(BaseRecord.STATE_ACCEPTED));%>"/>
                    <%
...
%>
            ...
            <tr>
                <td>Due Date</td>
                <td class="Odd"><input type="text" name="dueDate" id="dueDate" size="20" value="" readonly="1" />
                    <img src="./jscalendar/img.gif" id="btn_dueDate" style="cursor: pointer;" title="Date selector"/>
                </td>
            </tr>
            <tr>
                <td>Start Date</td>
                <td class="Odd"><input type="text" name="startDate" id="startDate" size="20" value="" readonly="1" />

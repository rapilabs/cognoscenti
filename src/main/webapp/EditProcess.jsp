...
%>
            ...
            <tr>
                <td>Start Date</td>
                <td class="odd">
                    <input type="text" name="startDate" id="startDate" size="20" value="<% SectionUtil.nicePrintDate(out, startDate); %>" readonly="1" />
            ...
            <tr>
                <td>End Date</td>
                <td class="odd">
                    <input type="text" name="endDate" id="endDate" size="20" value="<% SectionUtil.nicePrintDate(out, endDate); %>" readonly="1" />

...
public class DOMUtils {
   ...
   */
    ...
    public static List getChildElementsList(Node contextNode)
    {
    ...
    public static Vector getNamedChildrenVector(Element from, String name)
    {
        Vector list = new Vector() ;
        NodeList childNdList = from.getChildNodes();
        for (int i = 0 ; i < childNdList.getLength(); i++) {
   ...
   */
    ...
    {
        private ArrayList nodeVector = null;
        ...
        {
            return (Node)nodeVector.get(index);
        }
